    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    DateHiring = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DoctorSchedules_patients_PatientId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "21f62256-87fd-411e-8a39-64246f16e1d3", null, "Doctor", "DOCTOR" },
                    { "4636565b-229f-4d98-9696-edbc7c8e55fb", null, "Admin", "ADMIN" },
                    { "b90ce47d-2d46-4c25-9f0c-2da653f741e9", null, "Patient", "PATIENT" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorSchedules_PatientId",
                table: "DoctorSchedules",
                column: "PatientId");
