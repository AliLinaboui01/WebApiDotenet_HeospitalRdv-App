...
builder.Services.AddScoped<IDoctorScheduelRepository,DoctorScheduelRepository>();
builder.Services.AddScoped<IMedicalServiceRepository,MedicalServiceRepository>();
builder.Services.AddScoped<IMedicalServiceDoctorRepository,MedicalServiceDoctorRepository>();
builder.Services.AddScoped<IImageService,UploadImageService>();
